...
public partial class PlayersController
{
    ...
    {
        // Get movement input from both keyboard/mouse and controller.
        input = GetMovementInput();

        // Add other input-related actions as needed (e.g., jumping, attacking).
    }

    private Vector2 GetMovementInput()
    {
        // Get movement input from keyboard/mouse.
