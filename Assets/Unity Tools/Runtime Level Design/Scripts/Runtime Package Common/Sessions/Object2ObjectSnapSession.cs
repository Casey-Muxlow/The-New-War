...
namespace RLD
{
    ...
    public class Object2ObjectSnapSession
    {
        ...
        private bool _enableMoreControl = false;
        ...
        public bool IsSurfaceValid { get { return _sitSurface.SurfaceType != SitSurfaceType.Invalid; } }
        public bool EnableMoreControl { get { return _enableMoreControl; } set { _enableMoreControl = value; } }
        public GameObject SurfaceObject { get { return _sitSurface.SurfaceObject; } }
        ...
        private void SnapTargets()
        {
            ...
            if (!SharedHotkeys.EnableFlexiSnap.IsActive())
            {
                ...
                snapConfig.Prefs = _enableMoreControl || SharedHotkeys.EnableMoreControl.IsActive() ? Object2ObjectSnap.Prefs.None : Object2ObjectSnap.Prefs.TryMatchArea;
        ...
        private bool IdentifySitSurface()
        {
            ...
            _sitSurface.SurfaceObject = null;
            ...
            if (raycastHit.WasAnObjectHit && raycastHit.WasGridHit)
            {
                if (raycastHit.ObjectHit.HitEnter < raycastHit.GridHit.HitEnter)
                {
                    ...
                    _sitSurface.SurfaceObject = raycastHit.ObjectHit.HitObject;
                }
                else
                {
