...
namespace RLD
{
    ...
    public class Hotkeys
    {
        ...
        public bool IsActive(bool checkForOverlaps = true)
        {
            ...
            if (_lMouseBtn && !RTInput.IsMouseButtonPressed((int)MouseButton.Left)) return false;
            if (_rMouseBtn && !RTInput.IsMouseButtonPressed((int)MouseButton.Right)) return false;
            if (_mMouseBtn && !RTInput.IsMouseButtonPressed((int)MouseButton.Middle)) return false;
        ...
        public bool IsActiveInFrame(bool checkForOverlaps = true)
        {
            ...
            // Check if the corresponding mouse buttons are pressed
            if (_lMouseBtn && !RTInput.WasMouseButtonPressedThisFrame((int)MouseButton.Left)) return false;
            if (_rMouseBtn && !RTInput.WasMouseButtonPressedThisFrame((int)MouseButton.Right)) return false;
            if (_mMouseBtn && !RTInput.WasMouseButtonPressedThisFrame((int)MouseButton.Middle)) return false;
        ...
        {
            if (RTInput.IsMouseButtonPressed((int)MouseButton.Left)) return true;
            if (RTInput.IsMouseButtonPressed((int)MouseButton.Right)) return true;
            if (RTInput.IsMouseButtonPressed((int)MouseButton.Middle)) return true;
