...
namespace RLD
{
    public static class ObjectBounds
    {
        ...
        static ObjectBounds()
        {
            ...
            _defaultQConfig.LayerMask = ~0;
            _defaultQConfig.CustomFilter = null;
        }
        ...
        public static AABB CalcModelAABB(GameObject gameObject, QueryConfig queryConfig, GameObjectType objectType)
        {
            ...
            if (!LayerEx.IsLayerBitSet(queryConfig.LayerMask, gameObject.layer)) return AABB.GetInvalid();
            if (queryConfig.CustomFilter != null && !queryConfig.CustomFilter(gameObject)) return AABB.GetInvalid();
